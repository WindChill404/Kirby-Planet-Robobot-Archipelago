...
| `open_all_stages` | on/off (default **on**) | Normal stages in an area are open from the start. I highly recommend this stays on. It won't look like the stages are open but just trying walking to them. |
